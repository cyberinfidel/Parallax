		...
		"Anims": [
			{
				...
				"Frames":
					[
						["Graphics/Oreo/RunFast_014.png", 25, 36, 0, 0.015],
					]
			},
			{
				"Name": "Bunny Stands",
				...
				"Frames":
					[
						["Graphics/Oreo/Left/RunFast_014.png", 25, 36, 0, 0.015],
					]
			},
			{
				"Name": "Hero Runs Left",
				...
				"Frames":
					[
						["Graphics/Oreo/Left/RunFast_000.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_001.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_002.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_003.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_004.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_005.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_006.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_007.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_008.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_009.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_010.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_011.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_012.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_013.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_014.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_015.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_016.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_017.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_018.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/Left/RunFast_019.png", 25, 36, 0, 0.015],
					],
			},
			{
				...
				"Frames":
					[
						["Graphics/Oreo/RunFast_000.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_001.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_002.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_003.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_004.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_005.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_006.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_007.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_008.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_009.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_010.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_011.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_012.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_013.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_014.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_015.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_016.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_017.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_018.png", 25, 36, 0, 0.015],
						["Graphics/Oreo/RunFast_019.png", 25, 36, 0, 0.015],
					],
			},
			{
...
class Controller(px_controller.Controller):
	def __init__(self, game, data):
		...
		self.strikes = [
			...
			px_strike.Strike(cool=0.8, delay=0.4, duration = 0.2, range=Vec3(8, 10, 30), dim=Vec3(12, 8, 8), orig=Vec3(6, 4, 4),
			...
			px_strike.Strike(cool=1.5, delay=0.6, duration = 0.5, range=Vec3(16, 0, 0), dim=Vec3(10, 16, 30), orig=Vec3(5, 8, 20),
											 force=0.2, absorb=100, damage=0, template=hit_t),  # block
			px_strike.Strike(cool=0.8, delay=0.7, duration=0.1, range=Vec3(20, 0, 0), dim=Vec3(10, 16, 30), orig=Vec3(5, 8, 20),
