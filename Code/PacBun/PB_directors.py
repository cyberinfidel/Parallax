...
def director_meet(game):
	return [
				...
				Delay(1.5),
				Message("Pinkie.", Vec3(140,180,0), graphics.Color(1,0.8,0.8), 2, graphics.eAlign.centre),
				Spawn(spawns=[SpawnEntity('pinkie','pinkie', Vec3(140,150,1), game)]),
				Delay(1.6),
				Message("Blue.", Vec3(160,180,0), graphics.Color(0.5,0.5,1.0), 2, graphics.eAlign.centre),
				Spawn(spawns=[SpawnEntity('blue','blue', Vec3(160,150,1), game)]),
				Delay(0.9),
				Message("Bowie.", Vec3(180,180,0), graphics.Color(1.0,1.0,1.0), 2, graphics.eAlign.centre),
